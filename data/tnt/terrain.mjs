...
export default [
  ...
  {
    id: "forest_tnt",
    name: { ja: "森TNT", en: "Forest TNT" },
    desc: { ja: "木が一斉に育ち、その場に森ができる。", en: "Trees shoot up all at once and a forest takes hold." },
    blast: { power: 0, breaks: false, fire: false },
    visual: { color: "#3c7c30", emblem: "tree", trail: "minecraft:villager_happy" },
    effect: "forestEffect",
    recipe: { ingredients: ["manytnt:grass_tnt", "minecraft:oak_sapling", "minecraft:bone_meal"] },
  },
  {
    id: "cave_tnt",
    name: { ja: "洞窟TNT", en: "Cavern TNT" },
    desc: { ja: "足元に枝分かれした洞窟を掘り抜く。探検の入口になる。", en: "Opens a branching cavern below your feet. A way in." },
    blast: { power: 0, breaks: false, fire: false },
    visual: { color: "#54504c", emblem: "cave", trail: "minecraft:basic_smoke_particle" },
    effect: "caveEffect",
    recipe: { ingredients: ["manytnt:shaft_tnt", "minecraft:stone", "minecraft:stone", "minecraft:torch"] },
  },
  {
    id: "lake_tnt",
    name: { ja: "湖TNT", en: "Lake TNT" },
    desc: { ja: "椀形の窪みを掘って水で満たす。砂浜まで付く。", en: "Scoops out a bowl and fills it with water, beach included." },
    blast: { power: 0, breaks: false, fire: false },
    visual: { color: "#3c8cc8", emblem: "lake", trail: "minecraft:basic_bubble_particle" },
    effect: "lakeEffect",
    recipe: { ingredients: ["manytnt:water_tnt", "minecraft:water_bucket", "minecraft:sand"] },
  },
  {
    id: "nether_tnt",
    name: { ja: "ネザー化TNT", en: "Netherize TNT" },
    desc: { ja: "一帯をネザーの地形に作り替える。溶岩溜まりまで湧く。", en: "Rewrites the area as the Nether, lava pools and all." },
    blast: { power: 6, breaks: true, fire: true },
    visual: { color: "#8c2a2a", band: "#5c1c1c", emblem: "nether", trail: "minecraft:basic_flame_particle" },
    effect: "netherEffect",
    recipe: { ingredients: ["manytnt:scorched_tnt", "minecraft:netherrack", "minecraft:soul_sand", "minecraft:magma"] },
  },
];
