...
Minecraft 統合版 (Bedrock) 向けのアドオン。**72種類**のユニークなTNTと、
...
| | 内容 | 例 |
| --- | --- | --- |
| 基本 | 素直に爆発するだけ | メガ・ミニ・ロケット・ガチャ |
| 核兵器 | このアドオンの最大火力 | 核・超核・水素爆弾・ツァーリボンバ・反物質・終焉 |
| 属性 | 火・水・氷・雷といった自然の力 | 火炎・氷結・雷・溶岩・津波・氷河期 |
| 移動 | 引き寄せ・打ち上げ・転移 | 重力・反重力・テレポート・ブラックホール |
| 生物 | モブを呼び出す | 召喚・雪だるま・ハチ・動物・UFO |
| 地形 | 壊すより整える | 草原・砂漠・建材・縦穴・豊作・製錬 |
| 便利 | 回復・収集・照明 | 回復・お宝・経験値・発光・満腹 |
| 演出 | 見て楽しむ | 紙吹雪・虹・ディスコ・花火・隕石 |
| 災厄 | 常軌を逸したもの | 特異点・時間停止・地殻貫通・崩落・増殖 |
...
紋章は72種類を見分けられるよう帯 (5〜10行) を越えて本体の上まで使い、
